...
<section class="container-fluid">
  <div class="row">
   <%--  <aside class="col-sm-3 col-md-2 col-lg-2 sidebar">
      ...
      <ul class="nav nav-sidebar">
        <li class="active"><a href="${pageContext.request.contextPath}/back/blog/findAllBlog">文章</a></li>
          ...
          <div class="col-md-3">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-footer">
                ...
                <input class="btn btn-primary" onclick="tijiao();" type="button" name="submit" value="投稿"/>
              </div>
            </div>
          </div>
        </form>
...
//            	var url="addBlog.action";
            	$.ajax({
	            	url:"${pageContext.request.contextPath}/front/blog/addContributeBlog",
	            	data: data,
	            	type: 'post',
	            	success:function(responseText){
	            		if(JSON.parse(responseText).status==200){
	            		alert("投稿成功");
	            			location.href="${pageContext.request.contextPath}/front/blog/findAllBlogByuserId";
	            		}else{

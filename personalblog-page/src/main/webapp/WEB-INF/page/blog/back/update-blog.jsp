        ...
        <form action="/Article/update" method="post" class="add-article-form">
          <div class="col-md-9">
            ...
            <div class="form-group">
              ...
              <input type="text" id="article-title" name="title" class="form-control" placeholder="在此处输入标题" value="${blogcontentVo.title}" required autofocus autocomplete="off">
            </div>
            <div class="form-group">
              <label for="article-content" class="sr-only">内容</label>
              <script id="article-content" name="content" type="text/plain">${blogcontentVo.content}</script>
            </div>
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
              	...
              	<textarea class="form-control" id="describe" name="describe" autocomplete="off">${blogcontentVo.abstrac}</textarea>
          ...
          <div class="col-md-3">
              ...
              <div class="add-article-box-content">
                <ul class="category-list">
                 <c:forEach var="sectionVo" items="${sectionVos }">
                  <li>
                    <label>
                  <%--   <input type="text" value="${sectionVo.sectionId}"/> --%>
                      <input name="category" type="radio" class="radi" value="${sectionVo.sectionId}" checked="checked">
           ...
           <!--  <div class="add-article-box">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-footer">
                <input class="btn btn-primary" onclick="update();"  type="button" name="submit" value="更新"/>
                <input class="btn btn-primary" onclick="fabu();"  type="button" name="submit"  value="发布"/>
              </div>
            </div>
          </div>
        </form>
...
var ue=UE.getEditor('article-content'); 
            function update(){
            	...
            	$("#message").html(html);
            	var url="updateBlog.action?blogcontentId=${blogcontentVo.blogContentId}";
            	
            	$.post(
            		url,
            		{"content":html,"title":title,"visiable":visiable,"sectionId":sectionId,"abstrac":abstrac},

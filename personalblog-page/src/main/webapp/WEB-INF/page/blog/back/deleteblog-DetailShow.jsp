...
<body>
    <div id="container" class="clearfix">        <div class="fl left-aside">
            <div class="post">
                <div class="post-top">
               ...
               <!--  <div class="reader-opinion clearfix">
                    <p class="fl"><span class="good iconfont">&#xe717;</span>赞<span class="count"></span></p>
		    ...
		    var GG = {
		        "kk":function(mm){
		         //alert(count);
		            ...
		            //alert(mm);
		            window.location.href="${ctx}/comment/back/blogDetail?pageNow="+mm+"&blogId="+blogId+"#current-comment";
		        }
		    }

...
<section class="container-fluid">
  <div class="row">
      <form action="/Article/checkAll" method="post" >
        ...
        <ol class="breadcrumb">
          <li><a href="add-blog">增加文章</a></li>
          <li><a href="${pageContext.request.contextPath}/back/blog/findAllDraftBlog">草稿箱</a></li>
        </ol>
...
/*   function tijiao(){
    ...
    <script type="text/javascript">
		    ...
		    var GG = {
		        "kk":function(mm){
		            window.location.href="${ctx}/back/blog/findAllBlog?pageNow="+mm;
		        }
		    }
